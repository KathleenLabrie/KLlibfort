	SUBROUTINE QSORT_INDEX (A,IA,N,M)
C
C THIS SUBROUTINE IS AN IMPLEMENTATION OF HOARE'S QUICKSORT
C USING THE ALGORITHIM GIVEN BY KNUTH IN "THE ART OF COMPUTER
C PROGRAMING", VOL. 3, PAGES 116-123. IT IS JUST LIKE QSORT,
C EXCEPT THAT, IN ADDITION TO DOING AN IN-PLACE SORT OF ARRAY
C A, IT ALSO RETURNS THE ORDERING OF THE ORIGINAL ARRAY ELEMENTS.
C
...
C
C
	INTEGER N,M,ISTACK(2,20),ISP,IL,IR,I,J,IA(1)
C
